...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000007a584d29a2cb6b0204fa72fcfddefb93cf3a99764bd70fb96fc92b0d65f"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 29711;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 savenode starting difficulty is 1 / 2^12
         ...
         */
        const char* pszTimestamp = "savenode new blockchain is here";
        ...
        genesis.nNonce = 3143938;

        hashGenesisBlock = uint256("0x000007a584d29a2cb6b0204fa72fcfddefb93cf3a99764bd70fb96fc92b0d65f");
        ...
        assert(hashGenesisBlock == uint256("0x000007a584d29a2cb6b0204fa72fcfddefb93cf3a99764bd70fb96fc92b0d65f"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // savenode: 1 day
        nTargetSpacing = 1 * 60;  // savenode: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet savenode addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet savenode script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet savenode BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet savenode BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet savenode BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // savenode: 1 day
        nTargetSpacing = 1 * 60;        // savenode: 1 minutes
