/* src/config/savenode-config.h.  Generated from savenode-config.h.in by configure.  */
/* src/config/savenode-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef savenode_CONFIG_H

#define savenode_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.savenode.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "savenode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "savenode Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "savenode"
