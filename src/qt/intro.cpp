...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("savenode Core"),
     ...
     * override -datadir in the savenode.conf file in the default data directory
     * (to be consistent with savenoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
