...
/** Utility functions used by the savenode Qt UI.
 */
namespace GUIUtil
{
...
// Render savenode addresses in monospace font
...
// Parse "savenode:" URI into recipient object, return true on successful parsing
