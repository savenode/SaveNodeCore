...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case savenode:
            return QString("savenode");
        case msnd:
            return QString("Milli-savenode (1 / 1" THIN_SP_UTF8 "000)");
        case usnd:
            return QString("Micro-savenode (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
