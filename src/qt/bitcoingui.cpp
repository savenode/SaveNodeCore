                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("savenode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a savenode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and savenode: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About savenode Core"), this);
    aboutAction->setStatusTip(tr("Show information about savenode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for savenode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your savenode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified savenode addresses"));
    ...
    openAction->setStatusTip(tr("Open a savenode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the savenode Core help message to get a list with possible savenode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("savenode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to savenode network", "", count));
}
...
{
    QString strTitle = tr("savenode Core"); // default title
...
/** Creates context menu, its actions, and savenodes up all the relevant signals for mouse events. */
