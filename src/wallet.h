...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 savenode at the same time
...
enum ZerocoinSpendStatus {
    Zsavenode_SPEND_OKAY = 0,                            // No error
    Zsavenode_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    Zsavenode_WALLET_LOCKED = 2,                         // Wallet was locked
    Zsavenode_COMMIT_FAILED = 3,                         // Commit failed, reset status
    Zsavenode_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    Zsavenode_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    Zsavenode_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    Zsavenode_TRX_CREATE = 7,                            // Everything related to create the transaction
    Zsavenode_TRX_CHANGE = 8,                            // Everything related to transaction change
    Zsavenode_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    Zsavenode_INVALID_COIN = 10,                         // Selected mint coin is not valid
    Zsavenode_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    Zsavenode_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    Zsavenode_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    Zsavenode_SPENT_USED_Zsavenode = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZsavenodeAutoBackups(bool fEnabled)
    {
