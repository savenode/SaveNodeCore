...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop savenode server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "savenode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* savenode features */
        {"savenode", "masternode", &masternode, true, true, false},
        {"savenode", "listmasternodes", &listmasternodes, true, true, false},
        {"savenode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"savenode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"savenode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"savenode", "masternodedebug", &masternodedebug, true, true, false},
        {"savenode", "startmasternode", &startmasternode, true, true, false},
        {"savenode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"savenode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"savenode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"savenode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"savenode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"savenode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"savenode", "mnbudget", &mnbudget, true, true, false},
        {"savenode", "preparebudget", &preparebudget, true, true, false},
        {"savenode", "submitbudget", &submitbudget, true, true, false},
        {"savenode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"savenode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"savenode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"savenode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"savenode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"savenode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"savenode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"savenode", "checkbudgets", &checkbudgets, true, true, false},
        {"savenode", "mnsync", &mnsync, true, true, false},
        {"savenode", "spork", &spork, true, true, false},
        {"savenode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"savenode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use savenoded, or the -server option to savenode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> savenode-cli " + methodname + " " + args + "\n";
}
