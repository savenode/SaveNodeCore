...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("savenode Core savenode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  savenode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded savenode transaction") + "\n" +
                               "  savenode-tx [options] -create [commands]   " + _("Create hex-encoded savenode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded savenode transaction
