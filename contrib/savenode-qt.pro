...
RESOURCES += src/qt/savenode.qrc src/qt/savenode_locale.qrc

TRANSLATIONS += src/qt/locale/savenode_bg.ts \
                src/qt/locale/savenode_de.ts \
                src/qt/locale/savenode_en.ts \
                src/qt/locale/savenode_es.ts \
                src/qt/locale/savenode_fi.ts \
                src/qt/locale/savenode_fr.ts \
                src/qt/locale/savenode_it.ts \
                src/qt/locale/savenode_ja.ts \
                src/qt/locale/savenode_pl.ts \
                src/qt/locale/savenode_pt.ts \
                src/qt/locale/savenode_ru.ts \
                src/qt/locale/savenode_sk.ts \
                src/qt/locale/savenode_sv.ts \
                src/qt/locale/savenode_vi.ts \
                src/qt/locale/savenode_zh_CN.ts \
                src/qt/locale/savenode_zh_TW.ts
