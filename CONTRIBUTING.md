Contributing to savenode Core
============================

The savenode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the savenode Core project, and is not to be
confused with overall savenode Network Protocol consensus changes.

Whether a pull request is merged into savenode Core rests with the project merge
...
Patches that change savenode consensus rules are considerably more involved than
...
Where a patch set proposes to change the savenode consensus, it must have been
...
The project leader is the release manager for each savenode Core release.
