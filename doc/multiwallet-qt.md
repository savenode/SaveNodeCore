...
In order to support loading of multiple wallets in savenode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is savenode.cpp.
...
Changes to savenode.cpp
----------------------
savenode.cpp is the entry point into savenode-qt, and as such, will require some minor modifications to provide hooks for
